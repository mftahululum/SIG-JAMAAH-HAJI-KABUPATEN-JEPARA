...
var style_JEPARAPEREMPUAN2019_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PEREMPUAN 2019");
    var labelText = "";
    size = 0;
    ...
    if (value > 3.000000 && value <= 21.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 21.000000 && value <= 40.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 40.000000 && value <= 61.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 61.000000 && value <= 76.000000) {
            style = [ new ol.style.Style({
